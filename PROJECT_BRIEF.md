...
- Implement a **Book class** with attributes such as:
    - `title`
    - `author`
    - `ISBN`
    - `publication year`
...
- Create a system to:
    - add books
    - remove books
    - update books in the library inventory

- Implement a **search functionality** to find books by:
    - title
    - author
    - ISBN
...
- Implement a **book recommendation system** based on:
...
- Implement **at least two design patterns** relevant to the problem:
    - Observer Pattern
    - Factory Pattern
    - Strategy Pattern
